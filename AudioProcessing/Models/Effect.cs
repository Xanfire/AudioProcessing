...
{    
    ...
    public abstract class Effect
    {
        ...
        public void AddSlider(List<Slider> sliders)
        {
            this.sliders = sliders;
        }

        public abstract string Name { get; }
        protected float slider1 { get { return (float)sliders[0].Value; } }
        protected float slider2 { get { return (float)sliders[1].Value; } }
        protected float slider3 { get { return (float)sliders[2].Value; } }
        protected float slider4 { get { return (float)sliders[3].Value; } }
        protected float slider5 { get { return (float)sliders[4].Value; } }
        protected float slider6 { get { return (float)sliders[5].Value; } }
        protected float slider7 { get { return (float)sliders[6].Value; } }
        protected float slider8 { get { return (float)sliders[7].Value; } }
